...
median-dispersion one of \figFiveCands{} candidates, not the largest.}
...
depth $m=2|C|$ at \flickerLineHz\,Hz, against a floor of \modFloorSix{} for
\sixMinEvents{} events drawn at random phase. $Z_{\flickerLineHz}$ and
...
with each other; \emph{locked} is the fraction of boxes whose local excess at
...
least \sixMinEvents{} events and no frame-level requirement applies.
...
\modFloorSix{} quoted against the depths of Table~\ref{tab:sixseq} is the expected depth of
